...
from syne_tune_local.try_import import try_import_aws_message, try_import_visual_message
from syne_tune_local.util import experiment_path, s3_experiment_path, metric_name_mode
...
class ExperimentResult:
    ...
    :param tuner: :class:`~syne_tune_local.Tuner` object stored along with results
    ...
    def creation_date(self):
        """
        :return: Timestamp when :class:`~syne_tune_local.Tuner` was created
        """
    ...
    def plot_hypervolume(
        ...
        **plt_kwargs,
        ...
        if self.results is not None and len(self.results) > 0:
            from syne_tune_local.optimizer.schedulers.multiobjective.utils import (
...
def load_experiments_df(
    ...
    :return: Dataframe that contains all evaluations reported by tuners according
        ...
        evaluated, metrics reported via :class:`~syne_tune_local.Reporter`. These metrics
