...
class TrialsOfExperimentResults:
    ...
    Compared to :class:`~syne_tune_local.experiments.ComparativeResults`, each subfigure
    ...
    :class:`~syne_tune_local.experiments.PlotParameters` as in
    :class:`~syne_tune_local.experiments.ComparativeResults`, but some fields are not
