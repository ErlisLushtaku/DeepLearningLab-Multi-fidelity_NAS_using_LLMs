...
from syne_tune_local.config_space import config_space_to_json_dict
...
class PythonBackend(LocalBackend):
    ...
    .. code-block:: python
       ...
       from syne_tune_local.backend import PythonBackend
    ...
    :class:`~syne_tune_local.backend.LocalBackend`:
