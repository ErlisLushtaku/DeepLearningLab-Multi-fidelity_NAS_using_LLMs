...
from syne_tune_local.util import RegularCallback
...
class ExtraResultsComposer:
    ...
    def __call__(self, tuner) -> Optional[Dict[str, Any]]:
        ...
        :param tuner: :class:`~syne_tune_local.Tuner` object from which extra results
            are extracted
...
class StoreResultsCallback(TunerCallback):
    ...
    :param add_wallclock_time: If ``True``, wallclock time since call of
        ...
        :const:`~syne_tune_local.constants.ST_TUNER_TIME`.
