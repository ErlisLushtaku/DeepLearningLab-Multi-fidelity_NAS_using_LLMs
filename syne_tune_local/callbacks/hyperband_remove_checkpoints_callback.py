...
from syne_tune_local.callbacks.hyperband_remove_checkpoints_score import (
    compute_probabilities_of_getting_resumed,
)
from syne_tune_local.optimizer.scheduler import SchedulerDecision
from syne_tune_local.optimizer.schedulers.hyperband_stopping import PausedTrialsResult
...
class HyperbandRemoveCheckpointsCallback(HyperbandRemoveCheckpointsCommon):
    ...
    :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler` (only for
