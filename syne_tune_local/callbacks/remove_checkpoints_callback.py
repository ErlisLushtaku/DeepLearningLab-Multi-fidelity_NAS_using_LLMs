...
class RemoveCheckpointsCallback(TunerCallback):
    ...
    :meth:`~syne_tune_local.optimizer.scheduler.TrialScheduler.trials_checkpoints_can_be_removed`.
    """
...
class DefaultRemoveCheckpointsSchedulerMixin(RemoveCheckpointsSchedulerMixin):
    ...
    :class:`~syne_tune_local.optimizer.schedulers.remove_checkpoints.RemoveCheckpointsSchedulerMixin`,
