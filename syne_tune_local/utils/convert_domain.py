...
from syne_tune_local.util import is_integer
...
def convert_choice_domain(domain: Categorical, name: Optional[str] = None) -> Domain:
    ...
    converted to :func:`~syne_tune_local.config_space.finrange`,
    :func:`~syne_tune_local.config_space.logfinrange`,
    :func:`~syne_tune_local.config_space.ordinal`, or
    :func:`~syne_tune_local.config_space.logordinal`. Otherwise, ``domain`` is
    returned as is.
...
def convert_domain(domain: Domain, name: Optional[str] = None) -> Domain:
    ...
    * ``domain`` is categorical, its values are numerical. This is converted to
      :func:`~syne_tune_local.config_space.finrange`,
      :func:`~syne_tune_local.config_space.logfinrange`,
      :func:`~syne_tune_local.config_space.ordinal`, or
      :func:`~syne_tune_local.config_space.logordinal`. We fit the values or their
