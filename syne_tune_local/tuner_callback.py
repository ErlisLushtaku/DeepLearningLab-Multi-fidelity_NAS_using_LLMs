...
class TunerCallback:
    """
    Allows user of :class:`~syne_tune_local.Tuner` to monitor progress, store
    ...
    def on_tuning_start(self, tuner):
        ...
        :param tuner: :class:`~syne_tune_local.Tuner` object
        """
        pass
    ...
    def on_tuning_end(self):
        ...
        This is called before :class:`~syne_tune_local.Tuner` object is serialized
