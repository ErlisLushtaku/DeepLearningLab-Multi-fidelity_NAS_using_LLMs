...
from syne_tune_local.backend.sagemaker_backend.instance_info import InstanceInfos
...
class Reporter:
    ...
    :param add_time: If True (default), the time (in secs) since creation of the
        ...
        :const:`~syne_tune_local.constants.ST_WORKER_TIME`
    :param add_cost: If True (default), estimated dollar cost since creation of
        :class:`Reporter` object is reported automatically as
        :const:`~syne_tune_local.constants.ST_WORKER_COST`. This is available for
    ...
    def __call__(self, **kwargs) -> None:
        ...
        A time stamp :const:`~syne_tune_local.constants.ST_WORKER_TIMESTAMP` is added.
