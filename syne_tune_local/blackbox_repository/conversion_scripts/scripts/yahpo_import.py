...
from syne_tune_local.blackbox_repository.serialize import (
    serialize_metadata,
)
import syne_tune_local.config_space as cs
from syne_tune_local.blackbox_repository.blackbox import Blackbox
from syne_tune_local.constants import ST_WORKER_ITER
...
class BlackBoxYAHPO(Blackbox):
    ...
    :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler`, in that all
