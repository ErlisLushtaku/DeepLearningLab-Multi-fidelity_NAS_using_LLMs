...
from syne_tune_local.backend.trial_status import Status
from syne_tune_local.blackbox_repository import add_surrogate, load_blackbox
from syne_tune_local.blackbox_repository.blackbox import Blackbox
from syne_tune_local.blackbox_repository.blackbox_tabular import BlackboxTabular
from syne_tune_local.blackbox_repository.utils import metrics_for_configuration
...
class BlackboxRepositoryBackend(_BlackboxSimulatorBackend):
    ...
    new dataset* section of ``syne_tune_local/blackbox_repository/README.md``.
    ...
    .. note::
       ...
       different from what
       :class:`~syne_tune_local.backend.simulator_backend.SimulatorBackend` requires
    ...
    :param surrogate_kwargs: Arguments for the scikit-learn estimator, for
        ...
        as ``yahpo_kwargs`` to
        :func:`~syne_tune_local.blackbox_repository.load_blackbox`. In this case,
