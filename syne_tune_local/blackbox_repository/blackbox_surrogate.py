...
from syne_tune_local.config_space import Categorical
from syne_tune_local.blackbox_repository.blackbox import (
    Blackbox,
    ObjectiveFunctionResult,
)
from syne_tune_local.blackbox_repository.blackbox_offline import BlackboxOffline
...
class BlackboxSurrogate(Blackbox):
    ...
    :param surrogate: the model that is fitted to predict objectives given any
        ...
        :class:`~syne_tune_local.config_space.Categorical` values are one-hot encoded).
...
def add_surrogate(
    ...
    :param blackbox: the blackbox must implement
        :meth:`~syne_tune_local.blackbox_repository.Blackbox.hyperparameter_objectives_values`
    ...
    :param predict_curves: If True, the surrogate uses multivariate regression
        ...
        :class:`~syne_tune_local.blackbox_repository.BlackboxOffline`, otherwise ``True``.
