...
from syne_tune_local.blackbox_repository.blackbox import (
    Blackbox,
...
class BlackboxTabular(Blackbox):
    ...
    :class:`~syne_tune_local.blackbox_repository.BlackboxOffline`, as performance
    improvement can be made by avoiding to repeat hyperparameters and by storing
    all evaluations in a single table.

    Additional arguments on top of parent class
    :class:`~syne_tune_local.blackbox_repository.Blackbox`:
    ...
    def all_configurations(self) -> List[Dict[str, Any]]:
        ...
        :class:`~syne_tune_local.optimizer.schedulers.searchers.StochasticAndFilterDuplicatesSearcher`
        or
...
def deserialize(path: str) -> Dict[str, BlackboxTabular]:
    ...
    :func:`deserialize` for :class:`~syne_tune_local.blackbox_repository.BlackboxOffline`
