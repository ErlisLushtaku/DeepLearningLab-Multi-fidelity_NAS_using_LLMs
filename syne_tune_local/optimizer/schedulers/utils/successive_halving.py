...
def successive_halving_rung_levels(
    ...
    :param grace_period: See :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler`
    :param reduction_factor: See :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler`
    :param rung_increment: See :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler`
