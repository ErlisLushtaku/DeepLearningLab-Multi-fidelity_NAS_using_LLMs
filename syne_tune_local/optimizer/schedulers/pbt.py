...
from syne_tune_local.config_space import Domain, Integer, Float, FiniteRange
...
class PopulationBasedTraining(FIFOScheduler):
    ...
    Note: While this is implemented as child of :class:`~syne_tune_local.optimizer.schedulers.FIFOScheduler`, we
    require ``searcher="random"`` (default), since the current code only supports
    a random searcher.

    Additional arguments on top of parent class :class:`~syne_tune_local.optimizer.schedulers.FIFOScheduler`.
