...
from syne_tune_local.optimizer.schedulers.searchers.gp_fifo_searcher import (
    GPFIFOSearcher,
    decode_state,
)
...
class GPMultiFidelitySearcher(GPFIFOSearcher):
    ...
    :class:`~syne_tune_local.optimizer.schedulers.MultiFidelitySchedulerMixin`. It
    ...
    Most of :class:`~syne_tune_local.optimizer.schedulers.searchers.GPFIFOSearcher`
    ...
    :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler`). The kernel
    ...
    :param gp_resource_kernel: Only relevant for ``model == "gp_multitask"``.
        ...
        :const:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.models.kernel_factory.SUPPORTED_RESOURCE_MODELS`
    ...
    :param max_size_data_for_model: If this is set, we limit the number of
        ...
        :class:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.utils.subsample_state.SubsampleMultiFidelityStateConverter`
