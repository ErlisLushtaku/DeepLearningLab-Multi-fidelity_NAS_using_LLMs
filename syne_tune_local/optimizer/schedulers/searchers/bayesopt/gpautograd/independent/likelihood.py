...
from syne_tune_local.optimizer.schedulers.searchers.bayesopt.gpautograd.likelihood import (
    MarginalLikelihood,
    GaussianProcessMarginalLikelihood,
)
from syne_tune_local.optimizer.schedulers.searchers.bayesopt.gpautograd.independent.posterior_state import (
...
from syne_tune_local.optimizer.schedulers.searchers.bayesopt.gpautograd.distribution import (
    Gamma,
    LogNormal,
)
from syne_tune_local.optimizer.schedulers.searchers.bayesopt.gpautograd.gluon_blocks_helpers import (
...
class IndependentGPPerResourceMarginalLikelihood(MarginalLikelihood):
    ...
    :param initial_noise_variance: Initial value for noise variance(s).
        Defaults to
        :const:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.gpautograd.constants.INITIAL_NOISE_VARIANCE`
    :param initial_covariance_scale: Initial value for covariance scales.
        Defaults to
        :const:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.gpautograd.constants.INITIAL_COVARIANCE_SCALE`
    :param encoding_type: Encoding used for noise variance(s) and covariance
        scales. Defaults to
        :const:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.gpautograd.constants.DEFAULT_ENCODING`
    """
