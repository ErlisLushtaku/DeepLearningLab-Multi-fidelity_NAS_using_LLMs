...
from syne_tune_local.optimizer.schedulers.searchers.bayesopt.models.estimator import (
    Estimator,
    transform_state_to_data,
)
from syne_tune_local.optimizer.schedulers.searchers.bayesopt.models.model_base import (
    BasePredictor,
)
...
from syne_tune_local.optimizer.schedulers.searchers.utils.common import ConfigurationFilter
from syne_tune_local.optimizer.schedulers.searchers.bayesopt.datatypes.tuning_job_state import (
    TuningJobState,
)
from syne_tune_local.optimizer.schedulers.searchers.utils.hp_ranges import (
    HyperparameterRanges,
)
from syne_tune_local.optimizer.schedulers.searchers.bayesopt.gpautograd.gp_regression import (
    GaussianProcessRegression,
)
from syne_tune_local.optimizer.schedulers.searchers.bayesopt.gpautograd.gpr_mcmc import (
    GPRegressionMCMC,
)
...
from syne_tune_local.optimizer.schedulers.searchers.bayesopt.gpautograd.posterior_state import (
    PosteriorState,
)
from syne_tune_local.optimizer.schedulers.searchers.bayesopt.tuning_algorithms.base_classes import (
    Predictor,
)
...
class GaussProcPredictor(BasePredictor):
    ...
    (e.g., :class:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.gpautograd.gp_regression.GaussianProcessRegression`),
    or integrated out by MCMC sampling
    (e.g., :class:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.gpautograd.gpr_mcmc.GPRegressionMCMC`).
...
class GaussProcEstimator(Estimator):
    ...
    def _posterior_for_state(
        ...
        :class:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.datatypes.common.FantasizedPendingEvaluations`,
    ...
    def _draw_fantasy_values(self, state: TuningJobState) -> TuningJobState:
        ...
        is because
        :class:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.gpautograd.gp_regression.GaussianProcessRegression`
