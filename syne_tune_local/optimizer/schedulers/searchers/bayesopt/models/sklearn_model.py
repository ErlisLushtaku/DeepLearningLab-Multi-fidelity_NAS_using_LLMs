...
from syne_tune_local.optimizer.schedulers.searchers.bayesopt.sklearn import (
    SKLearnPredictor,
    SKLearnEstimator,
)
...
class SKLearnPredictorWrapper(BasePredictor):
    ...
    :class:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.models.sklearn_estimator.SKLearnEstimatorWrapper`.
    """
...
class SKLearnEstimatorWrapper(Estimator):
    ...
    def fit_from_state(self, state: TuningJobState, update_params: bool) -> Predictor:
        """
        Creates a
        :class:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.tuning_algorithms.base_classes.Predictor`
        ...
        :meth:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.models.gp_model.GaussProcEstimator.fit_from_state`.
