...
from syne_tune_local.optimizer.schedulers.hyperband_promotion import (
    PromotionRungSystem,
)
from syne_tune_local.optimizer.schedulers.searchers import BaseSearcher
...
class DyHPORungSystem(PromotionRungSystem):
    ...
    Since :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler` was designed
    ...
    * Here, we use the fact that information can be passed from
      ...
      :meth:`~syne_tune_local.optimizer.schedulers.searchers.dyhpo.DynamicHPOSearcher.score_paused_trials_and_new_configs`,
    ...
    * :meth:`~syne_tune_local.optimizer.schedulers.searchers.dyhpo.DynamicHPOSearcher.get_config`
