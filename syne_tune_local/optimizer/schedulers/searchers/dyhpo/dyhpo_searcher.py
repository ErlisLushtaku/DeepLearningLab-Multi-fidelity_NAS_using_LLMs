...
class DynamicHPOSearcher(BaseSearcher):
    ...
    etal (see
    :class:`~syne_tune_local.optimizer.schedulers.searchers.dyhpo.DyHPORungSystem`).

    It is *not* recommended to create :class:`DynamicHPOSearcher` searcher
    objects directly, but rather to create
    :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler` objects with
    ...
    * The parameters of the surrogate model are not refit in every call of
    ...
    :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler` and
    ...
    def configure_scheduler(self, scheduler):
        from syne_tune_local.optimizer.schedulers import HyperbandScheduler
