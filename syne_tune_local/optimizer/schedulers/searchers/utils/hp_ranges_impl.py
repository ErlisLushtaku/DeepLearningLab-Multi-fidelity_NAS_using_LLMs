...
from syne_tune_local.optimizer.schedulers.searchers.utils.scaling import (
    Scaling,
    LinearScaling,
    get_scaling,
)
...
class HyperparameterRangeFiniteRange(HyperparameterRange):
    ...
    :class:`~syne_tune_local.config_space.FiniteRange`. Internally, we use an ``int``
    with linear scaling.
...
class HyperparameterRangeOrdinalEqual(HyperparameterRangeCategorical):
    ...
    :class:`~syne_tune_local.config_space.Ordinal`.
...
class HyperparameterRangeOrdinalNearestNeighbor(HyperparameterRangeCategorical):
    ...
    :class:`~syne_tune_local.config_space.OrdinalNearestNeighbor`.
...
class HyperparameterRangesImpl(HyperparameterRanges):
    ...
    :param name_last_pos: See :class:`~syne_tune_local.optimizer.schedulers.searchers.utils.HyperparameterRanges`, optional
    :param value_for_last_pos: See :class:`~syne_tune_local.optimizer.schedulers.searchers.utils.HyperparameterRanges`, optional
    :param active_config_space: See :class:`~syne_tune_local.optimizer.schedulers.searchers.utils.HyperparameterRanges`, optional
    :param prefix_keys: See :class:`~syne_tune_local.optimizer.schedulers.searchers.utils.HyperparameterRanges`, optional
    """
...
def decode_extended_features(
    ...
    :class:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.datatypes.config_ext.ExtendedConfiguration`,
