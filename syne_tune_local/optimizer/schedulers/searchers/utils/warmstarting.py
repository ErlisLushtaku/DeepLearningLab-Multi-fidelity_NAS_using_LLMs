...
def create_hp_ranges_for_warmstarting(**kwargs) -> HyperparameterRanges:
    """
    See :class:`~syne_tune_local.optimizer.schedulers.searchers.GPFIFOSearcher` for
    ...
    ``hp_ranges`` for a new
    :class:`~syne_tune_local.optimizer.schedulers.searchers.GPFIFOSearcher` object. It
    is also needed to create the
    :class:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.datatypes.tuning_job_state.TuningJobState`
