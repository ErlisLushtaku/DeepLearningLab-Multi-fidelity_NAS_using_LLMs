...
from syne_tune_local.optimizer.schedulers.searchers.bore.de import (
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.classifier == "xgboost":
            ...
            from syne_tune_local.optimizer.schedulers.searchers.bore.gp_classififer import (
                GPModel,
            )

            self.model = GPModel(**classifier_kwargs)
        elif self.classifier == "mlp":
            from syne_tune_local.optimizer.schedulers.searchers.bore.mlp_classififer import (
                MLP,
            )
