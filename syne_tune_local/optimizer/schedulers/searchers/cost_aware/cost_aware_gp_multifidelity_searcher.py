...
from syne_tune_local.optimizer.schedulers.searchers.gp_multifidelity_searcher import (
...
class CostAwareGPMultiFidelitySearcher(MultiModelGPMultiFidelitySearcher):
    ...
    :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler`). The searcher
    ...
    :class:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.models.meanstd_acqfunc_impl.EIpuAcquisitionFunction`).
    ...
    :type cost_model:
        :class:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.models.cost.cost_model.CostModel`, optional
    """
