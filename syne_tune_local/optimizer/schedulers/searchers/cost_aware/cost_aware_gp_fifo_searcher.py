...
from syne_tune_local.optimizer.schedulers.searchers.gp_fifo_searcher import GPFIFOSearcher
...
class MultiModelGPFIFOSearcher(GPFIFOSearcher):
    ...
    :class:`~syne_tune_local.optimizer.schedulers.searchers.GPFIFOSearcher`. We first
    call
...
class CostAwareGPFIFOSearcher(MultiModelGPFIFOSearcher):
    ...
    with :class:`~syne_tune_local.optimizer.schedulers.FIFOScheduler`). The searcher
