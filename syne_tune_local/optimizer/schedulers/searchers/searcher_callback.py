...
from syne_tune_local.optimizer.schedulers.searchers import ModelBasedSearcher
...
class StoreResultsAndModelParamsCallback(StoreResultsCallback):
    """
    Extends :class:`~syne_tune_local.tuner_callback.StoreResultsCallback` by also
...
class SimulatorAndModelParamsCallback(SimulatorCallback):
    """
    Extends
    :class:`~syne_tune_local.backend.simulator_backend.simulator_callback.SimulatorCallback`
