...
from syne_tune_local.optimizer.schedulers.searchers import (
    StochasticSearcher,
    RandomSearcher,
)
...
from syne_tune_local.optimizer.schedulers.searchers.bayesopt.tuning_algorithms.bo_algorithm import (
    BayesianOptimizationAlgorithm,
)
from syne_tune_local.optimizer.schedulers.searchers.bayesopt.tuning_algorithms.bo_algorithm_components import (
    NoOptimization,
...
from syne_tune_local.optimizer.schedulers.searchers.utils.exclusion_list import (
    ExclusionList,
...
from syne_tune_local.optimizer.schedulers.searchers.utils import HyperparameterRanges
from syne_tune_local.optimizer.schedulers.searchers.utils.common import (
    ConfigurationFilter,
    Configuration,
)
...
class ModelBasedSearcher(StochasticSearcher):
    ...
    an internal :class:`~syne_tune_local.optimizer.schedulers.searchers.RandomSearcher`
...
class BayesianOptimizationSearcher(ModelBasedSearcher):
    ...
    * Next, the BO decision is made based on
      :class:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.tuning_algorithms.bo_algorithm.BayesianOptimizationAlgorithm`.
