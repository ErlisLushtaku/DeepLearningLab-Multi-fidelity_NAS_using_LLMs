...
class StochasticSearcher(BaseSearcher):
    ...
    :type random_seed_generator: :class:`~syne_tune_local.optimizer.schedulers.random_seeds.RandomSeedGenerator`, optional
...
class StochasticAndFilterDuplicatesSearcher(StochasticSearcher):
    ...
    * Maintains exclusion list to filter out duplicates in
      :meth:`~syne_tune_local.optimizer.schedulers.searchers.BaseSearcher.get_config`
