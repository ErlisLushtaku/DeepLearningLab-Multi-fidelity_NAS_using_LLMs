...
from syne_tune_local.optimizer.schedulers.synchronous.dehb_bracket_manager import (
    DifferentialEvolutionHyperbandBracketManager,
)
from syne_tune_local.optimizer.schedulers.synchronous.hyperband_bracket import (
    SlotInRung,
)
from syne_tune_local.optimizer.schedulers.synchronous.hyperband import (
...
from syne_tune_local.optimizer.schedulers.searchers.searcher import (
    impute_points_to_evaluate,
)
from syne_tune_local.optimizer.schedulers.searchers.utils.hp_ranges_factory import (
    make_hyperparameter_ranges,
)
from syne_tune_local.optimizer.schedulers.searchers.utils.exclusion_list import ExclusionList
...
class DifferentialEvolutionHyperbandScheduler(SynchronousHyperbandCommon):
    ...
    * Only the initial configurations are drawn at random (or drawn from the
    ...
    :param rungs_first_bracket: Determines rung level systems for each
        bracket, see
        :class:`~syne_tune_local.optimizer.schedulers.synchronous.dehb_bracket_manager.DifferentialEvolutionHyperbandBracketManager`
