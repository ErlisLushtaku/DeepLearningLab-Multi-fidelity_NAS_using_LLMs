...
from syne_tune_local.callbacks.remove_checkpoints_callback import (
...
from syne_tune_local.optimizer.schedulers.synchronous.hyperband_bracket_manager import (
    SynchronousHyperbandBracketManager,
)
from syne_tune_local.optimizer.schedulers.synchronous.hyperband_bracket import SlotInRung
from syne_tune_local.optimizer.schedulers.synchronous.hyperband_rung_system import (
    RungSystemsPerBracket,
)
from syne_tune_local.optimizer.scheduler import TrialSuggestion, SchedulerDecision
from syne_tune_local.optimizer.schedulers.scheduler_searcher import TrialSchedulerWithSearcher
...
from syne_tune_local.config_space import cast_config_values
...
from syne_tune_local.optimizer.schedulers.searchers.searcher import BaseSearcher
from syne_tune_local.optimizer.schedulers.searchers.searcher_factory import searcher_factory
...
class SynchronousHyperbandCommon(
    ...
    :class:`~syne_tune_local.optimizer.schedulers.synchronous.SynchronousHyperbandScheduler`
    and
    :class:`~syne_tune_local.optimizer.schedulers.synchronous.DifferentialEvolutionHyperbandScheduler`
    """
...
class SynchronousHyperbandScheduler(
    ...
    :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler`, this is also
    ...
    :param bracket_rungs: Determines rung level systems for each bracket, see
        :class:`~syne_tune_local.optimizer.schedulers.synchronous.hyperband_bracket_manager.SynchronousHyperbandBracketManager`
    ...
    :param search_options: Passed to
        :func:`~syne_tune_local.optimizer.schedulers.searchers.searcher_factory`.
    ...
    :param random_seed: Master random seed. Generators used in the scheduler
        ...
        :class:`~syne_tune_local.optimizer.schedulers.random_seeds.RandomSeedGenerator`.
    ...
    :param max_resource_level: Largest rung level, corresponds to ``max_t`` in
        :class:`~syne_tune_local.optimizer.schedulers.FIFOScheduler`. Must be positive
        int larger than ``grace_period``. If this is not given, it is inferred
        like in :class:`~syne_tune_local.optimizer.schedulers.FIFOScheduler`. In
