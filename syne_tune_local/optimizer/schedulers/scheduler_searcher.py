...
from syne_tune_local.optimizer.scheduler import TrialSuggestion, TrialScheduler
from syne_tune_local.optimizer.schedulers.random_seeds import (
    RandomSeedGenerator,
...
class TrialSchedulerWithSearcher(TrialScheduler):
    ...
    :class:`~syne_tune_local.optimizer.schedulers.searchers.BaseSearcher` member
    ``searcher``. This searcher has a method
    :meth:`~syne_tune_local.optimizer.schedulers.searchers.BaseSearcher.configure_scheduler`
