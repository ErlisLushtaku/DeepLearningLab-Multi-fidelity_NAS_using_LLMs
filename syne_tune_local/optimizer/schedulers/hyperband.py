...
from syne_tune_local.backend.trial_status import Trial
from syne_tune_local.optimizer.scheduler import SchedulerDecision
from syne_tune_local.optimizer.schedulers.fifo import FIFOScheduler
from syne_tune_local.optimizer.schedulers.multi_fidelity import MultiFidelitySchedulerMixin
from syne_tune_local.optimizer.schedulers.hyperband_cost_promotion import (
    CostPromotionRungSystem,
)
from syne_tune_local.optimizer.schedulers.hyperband_pasha import PASHARungSystem
from syne_tune_local.optimizer.schedulers.hyperband_promotion import PromotionRungSystem
from syne_tune_local.optimizer.schedulers.hyperband_rush import (
    RUSHPromotionRungSystem,
    RUSHStoppingRungSystem,
)
from syne_tune_local.optimizer.schedulers.hyperband_stopping import (
    StoppingRungSystem,
    PausedTrialsResult,
)
from syne_tune_local.optimizer.schedulers.hyperband_checkpoint_removal import (
    create_callback_for_checkpoint_removal,
)
from syne_tune_local.optimizer.schedulers.remove_checkpoints import (
    RemoveCheckpointsSchedulerMixin,
)
from syne_tune_local.optimizer.schedulers.searchers.dyhpo.hyperband_dyhpo import (
    DyHPORungSystem,
...
from syne_tune_local.optimizer.schedulers.searchers.bracket_distribution import (
    DefaultHyperbandBracketDistribution,
)
from syne_tune_local.optimizer.schedulers.utils.successive_halving import (
    successive_halving_rung_levels,
)
from syne_tune_local.tuning_status import TuningStatus
from syne_tune_local.tuner_callback import TunerCallback
...
class HyperbandScheduler(
    ...
    **Pending evaluations**
    ...
    :param searcher: Searcher for ``get_config`` decisions. String values
        are passed to
        :func:`~syne_tune_local.optimizer.schedulers.searchers.searcher_factory` along
        with ``search_options`` and extra information. Supported values:
        :const:`~syne_tune_local.optimizer.schedulers.searchers.searcher_factory.SUPPORTED_SEARCHERS_HYPERBAND`.
        Defaults to "random" (i.e., random search)
    :type searcher: str or
        :class:`~syne_tune_local.optimizer.schedulers.searchers.BaseSearcher`
    ...
    :param type: Type of Hyperband scheduler. Defaults to "stopping".
        ...
        :class:`~syne_tune_local.optimizer.schedulers.hyperband_stopping.RungSystem`):
        ...
        * stopping: A config eval is executed by a single task. The task is
          ...
          continues. See
          :class:`~syne_tune_local.optimizer.schedulers.hyperband_stopping.StoppingRungSystem`.
        * promotion: A config eval may be associated with multiple tasks
          ...
          is chosen. See
          :class:`~syne_tune_local.optimizer.schedulers.hyperband_promotion.PromotionRungSystem`.
        * cost_promotion: This is a cost-aware variant of 'promotion', see
          :class:`~syne_tune_local.optimizer.schedulers.hyperband_cost_promotion.CostPromotionRungSystem`
        ...
        * rush_stopping: A variation of the stopping scheduler which requires
          ...
          continued. See
          :class:`~syne_tune_local.optimizer.schedulers.hyperband_rush.RUSHStoppingRungSystem`
          and
          :class:`~syne_tune_local.optimizer.schedulers.transfer_learning.RUSHScheduler`.
        * rush_promotion: Same as ``rush_stopping`` but for promotion, see
          :class:`~syne_tune_local.optimizer.schedulers.hyperband_rush.RUSHPromotionRungSystem`
        * dyhpo: A model-based scheduler, which can be seen as extension of
          ...
          :class:`~syne_tune_local.optimizer.schedulers.searchers.dyhpo.DynamicHPOSearcher`
    ...
    :param early_checkpoint_removal_kwargs: If given, speculative early removal
        ...
        :class:`~syne_tune_local.callbacks.hyperband_remove_checkpoints_callback.HyperbandRemoveCheckpointsCallback`.
    ...
    def _on_config_suggest(
        ...
        * elapsed_time: Time from start of experiment, set in
          :meth:`~syne_tune_local.optimizer.schedulers.FIFOScheduler._suggest`
        * bracket: Bracket in which new trial is started, set in
          :meth:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler._promote_trial`
...
class HyperbandBracketManager:
    ...
    :param scheduler_type: See :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler`.
    :param resource_attr: See :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler`.
    :param metric: See :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler`.
    :param mode: See :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler`.
    :param max_t: See :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler`.
    :param rung_levels: See :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler`.
    :param brackets: See :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler`.
    :param rung_system_per_bracket: See :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler`.
