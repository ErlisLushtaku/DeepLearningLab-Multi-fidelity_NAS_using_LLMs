...
from syne_tune_local.optimizer.schedulers.multiobjective.random_scalarization import (
...
from syne_tune_local.optimizer.schedulers.searchers.searcher_base import extract_random_seed
from syne_tune_local.optimizer.schedulers.searchers.utils import make_hyperparameter_ranges
...
class MultiObjectiveMultiSurrogateSearcher(BayesianOptimizationSearcher):
    ...
    :param estimator: Instance of
        :class:`~syne_tune_local.optimizer.schedulers.searchers.bayesopt.sklearn.estimator.SKLearnEstimator`
