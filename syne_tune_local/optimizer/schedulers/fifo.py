...
from syne_tune_local.optimizer.scheduler import (
    SchedulerDecision,
    TrialSuggestion,
)
from syne_tune_local.optimizer.schedulers.scheduler_searcher import TrialSchedulerWithSearcher

from syne_tune_local.backend.time_keeper import TimeKeeper, RealTimeKeeper
...
class FIFOScheduler(TrialSchedulerWithSearcher):
    ...
    :param searcher: Searcher for ``get_config`` decisions. String values
        ...
        :const:`~syne_tune_local.optimizer.schedulers.searchers.searcher_factory.SUPPORTED_SEARCHERS_FIFO`.
    ...
    :param max_t: Value for ``max_resource_level``. Needed for
        ...
        :class:`~syne_tune_local.optimizer.schedulers.ResourceLevelsScheduler`).
    ...
    :param time_keeper: This will be used for timing here (see
        ...
        Note: If you use
        :class:`~syne_tune_local.backend.simulator_backend.SimulatorBackend`, you need
        to pass its ``time_keeper`` here.
    :type time_keeper: :class:`~syne_tune_local.backend.time_keeper.TimeKeeper`,
        optional
    """
