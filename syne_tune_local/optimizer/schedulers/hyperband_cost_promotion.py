...
from syne_tune_local.optimizer.schedulers.hyperband_stopping import Rung
...
class CostPromotionRungSystem(PromotionRungSystem):
    ...
    have to be added up. See :class:`~syne_tune_local.optimizer.schedulers.HyperbandScheduler`
    for how this works.
    """
